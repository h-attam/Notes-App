...
const Main = ({ notes, availableTags }: Props) => {
  ...
  /*
    ...
    2)2.input ile seçilen etiketler note un içerisinde etiketler ile birebir eşleşmeli. Seçilen etiketler dizisindeki her bir etiket için note a ait etikletler arasında eşleşme kontrolü yapacağız.
  */
